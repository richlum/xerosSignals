#ifndef __SCANTOASCII_H__
#define __SCANTOASCII_H__
...
extern int state;
extern unsigned char kbcode[];
extern unsigned char kbshift[];
extern unsigned char kbctl[];
extern unsigned int kbtoa(unsigned char code);

extern int is_control_code(unsigned char code);
